...
def image_fill(img):    
    ...
    # 결과 이미지를 그립니다.
    plt.figure(figsize=(12, 6))  # width * height
    #plt.subplot(1, 2, 1), plt.imshow(img_rgb), plt.title('Contours 1'), plt.axis("off")
    plt.subplot(1, 2, 2), plt.imshow(img2_rgb), plt.title('Contours 2'), plt.axis("off")
